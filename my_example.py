...
try:
  ...
  possible_tags = ['morainelake', 'instautah', 'agameoftones', 'moodygrams', 'mg5k', 'beautifuldestinations', 
  'explorecanada', 'tourcanada', 'canada', 'banffnationalpark', 'banff', 'canadasworld', 'hikingadventures', 
  'discoverbanff', 'travelcanada', 'travelphotography', 'mybanff', 'canada', 'travel', 'adventure', 
  'hicanada', 'canada150', 'parkscanada', 'travelalberta', 'visitcanada', 'tourcanada', 'enjoycanada', 
